<template>
  <el-row :gutter="20">
    <el-col :span="6">
      <category @handleTreeNodeClick="treenodeclick"></category>
    </el-col>
    <el-col :span="18">
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          <el-form-item>
            <el-input v-model="dataForm.key" placeholder="输入检索值" clearable style="width:300px;"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button @click="getDataList()" style="width:100px;">查询</el-button>
        ...
        >
          ...
          <el-table-column prop="attrName" header-align="center" align="center" label="属性名" show-overflow-tooltip></el-table-column>
          <el-table-column
            v-if="attrtype == 1"
            prop="searchType"
            header-align="center"
...
　　　　　　　　　　<span v-if="scope.row.attrType == 1" >规格参数</span>                　　　　　　　　
          ...
          <el-table-column prop="valueSelect" header-align="center" align="center" label="可选值"  width="120">
            <template slot-scope="scope">
          ...
          <el-table-column prop="categoryName" header-align="center" align="center" label="所属分类" show-overflow-tooltip></el-table-column>
          <el-table-column
            v-if="attrtype == 1"
            prop="attrGroupName"
            header-align="center"
          ...
          >
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.attrId)" icon="el-icon-edit">编辑</el-button>
              <el-button type="text" size="small" @click="deleteHandle(scope.row.attrId)" icon="el-icon-delete">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-pagination
...
<script>
  ...
  import { getBSAttrList,delBatch } from "@/api/product/attr";
