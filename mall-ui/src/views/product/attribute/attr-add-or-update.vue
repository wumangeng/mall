  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="120px">
      ...
      <el-form-item label="属性名" prop="attrName">
        <el-input v-model="dataForm.attrName" placeholder="属性名" style="width: 500px"></el-input>
      </el-form-item>
      ...
      <el-form-item label="属性图标" prop="icon">
         <avue-input-icon v-model="dataForm.icon"  :icon-list="iconList" style="width: 500px"></avue-input-icon>
      </el-form-item>
...
<script>
  ...
  import { queryList } from "@/api/product/attrgroup";
  import { getAttrById,addObj,putObj } from "@/api/product/attr";
      ...
      init(id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.attrId) {
            getAttrById(this.dataForm.attrId).then(({data}) => {
              if (data && data.code === 0) {
                ...
                //attrGroupId
                //catelogPath
                this.catelogPath = data.data.catelogIdPath;
                this.$nextTick(() => {
