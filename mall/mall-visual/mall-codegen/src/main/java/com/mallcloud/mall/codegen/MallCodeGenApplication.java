...
package com.mallcloud.mall.codegen;

import com.mallcloud.mall.common.datasource.annotation.EnableDynamicDataSource;
...
public class MallCodeGenApplication {

	public static void main(String[] args) {
		SpringApplication.run(MallCodeGenApplication.class, args);
	}
