 ...
 */
public class MallUserAuthenticationConverter implements UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			MallUser user = new MallUser(id, deptId, username, N_A, true, true, true, true, authorities);
