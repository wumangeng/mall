...
import com.mallcloud.mall.common.security.exception.*;
 ...
 */
@Slf4j
public class MallWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
		...
		return new ResponseEntity<>(new MallAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
