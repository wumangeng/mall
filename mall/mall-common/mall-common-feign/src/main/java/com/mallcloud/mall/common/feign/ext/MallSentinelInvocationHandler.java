 ...
 */
@Slf4j
public class MallSentinelInvocationHandler implements InvocationHandler {
	...
	MallSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MallSentinelInvocationHandler other = (MallSentinelInvocationHandler) obj;
